...
public class SendPostStartNewConversation extends AsyncTask<String, Integer, String> {
    public String sendPost(String args)
    {
        ...
        String toid = segments[4];

        String apiurl = newurl+"/api/messages/startconversation/"+token+"-"+userid+"-"+toid;
        String response = "";
        try {
